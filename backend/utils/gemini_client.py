...
def analyze_crop_image(image_file):
    ...
    prompt = (
        ...
        "Devuelve un JSON con los siguientes campos exactos: "
        "nivel_maduracion, enfermedades, necesidades_nutricionales, tipo_cosecha, fecha_tentativa_cosecha, tiempo_siembra. "
        "'tipo_cosecha' debe ser el nombre del fruto o cultivo al que pertenece la planta, por ejemplo: 'tomate', 'zanahoria', etc. "
        "'necesidades_nutricionales' debe ser una lista separada por comas con lo que necesita el fruto o planta para desarrollarse (por ejemplo: potasio, hierro, agua), sin explicaciones. "
        "'fecha_tentativa_cosecha' debe estimar en días o semanas cuánto tiempo hace que fue cosechado (si aplica). "
        "'tiempo_siembra' debe estimar en días o semanas cuánto tiempo pasó desde que fue sembrado, basado en el estado actual de la planta o fruto. "
        ...
        "Si la imagen no corresponde a una fruta, verdura, legumbre o planta sembrada, devuelve un JSON donde todos los campos digan 'no aplica'. "
